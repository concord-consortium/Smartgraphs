...
Smartgraphs = SC.Application.create(
  ...
  showOutline:    NO, //typeof window.showOutline    !== 'undefined' ? window.showOutline    : YES,
  showEditButton: NO  //typeof window.showEditButton !== 'undefined' ? window.showEditButton : YES
